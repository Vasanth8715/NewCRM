...
public class CreateOrgTest extends BaseClasss {
	...
	public void CreateOrgnizationWithPhoneNumber_Test() throws Throwable {
		/* step 1: read test script data from excel file */
	...
	@Test(groups = "regressionTest")
	public void CreateOrgnizationWithIndustries_Test() throws Throwable {
		/* Step 1: read test script data from excel file */
